...
#### 📈 결과 및 성과
- Java Web을 활용하여 게시판을 만들어보는 경험을 함.
- JSP 를 활용하여 View 코드에서 데이터를 랜더링하여 화면의 필요한 곳에서 데이터를 뽑아내는 경험이 흥미로웠음.

#### 👩‍🎓 느낀 점 
- Java Web, JSP, Servlet 등의 기술을 웹 페이지를 만들며 실질적으로 어떻게 사용하는지 경험할 수 있어 매우 흥미로웠으며, 기술을 익힐 수 있는 계기가 되었다.
- 특히, Servlet 의 생명 주기와 JSP의 동작 원리를 이해할 수 있었다.
- 데이터베이스와의 통신(커넥션 생성 및 활용), 세션 관리, 헤더 정보 입력 등을 고려하며 구현하는 과정에서 전반적인 개발 프로세스를 경험해볼 수 있었다.
- 모르는 내용들을 학원 동료분들에게 배우고 및 구글링을 하며 어떤식으로 코드를 구현하는것이 조금 더 효율적일지 비교하고 고민하는 시간이 매우 흥미로웠다. 
